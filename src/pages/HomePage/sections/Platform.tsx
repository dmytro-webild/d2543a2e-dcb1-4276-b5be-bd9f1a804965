    ...
    <section aria-label="Features reveal cards bento section" className="py-20">
      <div className="flex flex-col gap-8 md:gap-10">
        <div className="flex flex-col items-center w-content-width mx-auto gap-2">
          ...
          <TextAnimation
            text={"ARIES Platform Capabilities"}
            variant={"slide-up"}
            gradientText={true}
            tag="h2"
          ...
          <TextAnimation
            text={"Transform your design workflow into an experience."}
            variant={"slide-up"}
            gradientText={false}
            tag="p"
...
export default function PlatformSection() {
  return (
    <div data-webild-section="platform" data-section="platform" id="platform">
      <PlatformInline />
    </div>
  );
}
