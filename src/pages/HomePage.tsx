...
export default function HomePage() {
  ...
  <div id="platform" data-section="platform">
    <SectionErrorBoundary name="platform">
      ...
      items={[
        {
          title: "AI Rendering",
          description: "Turn plans into photorealistic imagery.",
          href: "#",
          imageSrc: "http://img.b2bpic.net/free-photo/modern-office-space-with-futuristic-decor-furniture_23-2151797639.jpg",
        },
        {
          title: "Interior Viz",
          description: "High-fidelity interior visualization.",
          href: "#",
          imageSrc: "http://img.b2bpic.net/free-photo/brutalist-inspiration-architecture-background_23-2149162901.jpg",
        },
        {
          title: "Exterior Viz",
          description: "Generate realistic outdoor settings.",
          href: "#",
          imageSrc: "http://img.b2bpic.net/free-photo/photorealistic-timber-house-interior-with-wooden-decor-furnishings_23-2151263586.jpg",
        },
        {
          title: "Interactive",
          description: "Real-time design exploration tools.",
          href: "#",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-tablet-top-architectural-plan_23-2148269855.jpg",
        },
        {
        ...
        {
          title: "Collaboration",
          description: "Seamless professional integration.",
          href: "#",
          imageSrc: "http://img.b2bpic.net/free-photo/blueprint-architect-construction-project-sketch-concept_53876-133820.jpg",
        },
      ]}
      ...
      metrics={[
        {
          value: "100%",
          title: "Photorealism",
          description: "Achieve stunning visual accuracy every time.",
          imageSrc: "http://img.b2bpic.net/free-photo/3d-model-house-room_23-2150761110.jpg",
        },
        {
          value: "10x",
          title: "Speed",
          description: "Visualize projects in a fraction of the time.",
          imageSrc: "http://img.b2bpic.net/free-photo/3d-rendering-abstract-building_23-2150896640.jpg",
        },
      ]}
      textAnimation="slide-up"
    />
      ...
      plans={[
        {
          tag: "Architects",
          price: "Custom",
          description: "Professional toolset for large firm projects.",
          features: [
        ...
        },
        {
          ...
          tag: "Pro",
          price: "Custom",
          description: "Scale development visualization effortlessly.",
          features: [
      ...
      testimonials={[
        {
          name: "Elena Rossi",
          role: "Architect",
          quote: "ARIES transformed our client meetings entirely.",
          rating: 5,
        ...
        },
        {
          name: "Marcus Chen",
          role: "Developer",
          quote: "The speed and quality are unprecedented.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-pretty-young-woman-working-blueprint-working-place_23-2148203942.jpg",
        },
        {
          name: "Sophia Moore",
          role: "Interior Designer",
          quote: "I can explore endless finishes in seconds.",
          rating: 5,
        ...
        },
        {
          ...
          quote: "Unbeatable accuracy for modern developments.",
          rating: 5,
        ...
        },
        {
          name: "Dr. Sarah Lee",
          role: "Lead Architect",
          quote: "The visualization engine is world-class.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-confident-young-male-engineer-against-white-backdrop_23-2147843008.jpg",
        },
      ]}
      textAnimation="fade-blur"
    />
  ...
  <div id="faq" data-section="faq">
    <SectionErrorBoundary name="faq">
      ...
      items={[
        {
          question: "What files does ARIES support?",
          answer: "We support blueprints, sketches, CAD, and various image formats.",
        },
        {
          question: "Can I request revisions?",
          answer: "Yes, our interactive revision engine is built for feedback.",
        },
        {
          question: "Is the system secure?",
          answer: "Security is our top priority, ensuring project intellectual property stays protected.",
        },
      ]}
      textAnimation="slide-up"
    />
